...
> {
  ...
  constructor(
    @inject('datasources.test') dataSource: TestDataSource, @repository.getter('CargoRepository') protected cargoRepositoryGetter: Getter<CargoRepository>, @repository.getter('VacacionesRepository') protected vacacionesRepositoryGetter: Getter<VacacionesRepository>,
  ) {
