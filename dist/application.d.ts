...
declare const BackendVacacionesApplication_base: (new (...args: any[]) => {
    projectRoot: string;
...
export declare class BackendVacacionesApplication extends BackendVacacionesApplication_base {
